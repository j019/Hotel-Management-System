<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyData.aspx.cs" Inherits="HM.ModifyData" %>
...
<body>
   ...
   <class="w3-display-container w3-content" style="max-width:1500px;">
    ...
    <form id="form1" runat="server">
        ...
        <br/>
        <br/>
        <h2 class="auto-style9"><b>MODIFY ROOMS</b></h2>
        <table border="1" bgcolor="grey" class="auto-style10" >
             <tr>
            ...
            <tr>
                <td class="auto-style5"><b>Room Number:</b><br />
                 ...
                 <td class="auto-style6">
                     <br />
                     <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" Height="32px" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" Width="253px" DataSourceID="SqlDataSource2" DataTextField="RoomNumber" DataValueField="RoomNumber">
                     </asp:DropDownList>
                     <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:HMConnectionString %>" SelectCommand="SELECT [RoomNumber] FROM [Room]"></asp:SqlDataSource>
                </td>
            </tr>
            ...
            <tr>
                <td class="auto-style7"><b>Room Price:</b><br />
                 ...
                 <td class="auto-style8">
                     <asp:TextBox ID="TextBox3" runat="server" Height="34px" Width="255px" TextMode="SingleLine"></asp:TextBox>
                     <br />
                </td>
            </tr>
            <tr>
                <td class="auto-style7"><b>Room Capacity:</b><br />
                 ...
                 <td class="auto-style8">
                     <asp:TextBox ID="TextBox4" runat="server" Height="34px" Width="255px" TextMode="Number"></asp:TextBox>
                     <br />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="auto-style7"><b>Room Descriptions:</b><br />
                 ...
                 <td class="auto-style8">
                     <asp:TextBox ID="TextBox7" runat="server" Height="34px" Width="255px" BackColor="White" TextMode="MultiLine"></asp:TextBox>
                     <br />
                </td>
            </tr>
        </table>
        ...
        <asp:Button ID="Button1" runat="server" Height="49px" Text="MODIFY" Width="177px" BackColor="#66FF33" Font-Bold="True" OnClick="Button1_Click" OnClientClick="javascript:alert('Data Modify Successfully');" />
